...
export default function About(
    ...
    const structure = [
        ...
        { 
            title: about.gonullu.title,
            display: about.gonullu.display,
            items: about.gonullu.gonulluluk.map(gonullu => gonullu.role)
        },
    ]
    return (
        <Flex
            ...
            { about.tableOfContent.display && (
                <Flex
                    style={{ left: '0', top: '55%', transform: 'translateY(-50%)' }}
                    position="fixed"
            ...
            <Flex
                ...
                <Flex
                    ...
                    { about.gonullu.display && (
                        <>
                            <Heading
                                as="h2"
                                id={about.gonullu.title}
                                variant="display-strong-s"
                                marginBottom="m">
                                {about.gonullu.title}
                            </Heading>
                            <Flex
                                direction="column"
                                fillWidth gap="l" marginBottom="40">
                                {about.gonullu.gonulluluk.map((experience, index) => (
                                    <Flex
                                        key={`${experience.company}-${experience.role}-${index}`}
                                        fillWidth
                                        direction="column">
